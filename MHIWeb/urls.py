...
urlpatterns = [
    ...
    path('sort_data_assignments/', core_views.sort_data_assignments, name='sort_data_assignments'),
    path('roles/', core_views.roles, name='roles'),
    path('sort_data_roles/', core_views.sort_data_roles, name='sort_data_roles'),
